...
| Ставки растаможки (сид) | ✅ залиты | data/globerent/customs-rates.json: 28 кодов ТН ВЭД со ставками 2026 (перенос сида 025_phase13 донора, xls «Таможенные ставки на 2026») + БРВ 412 000 с 2026-01-01. Кодов вилочных погрузчиков (8427…) в источниках нет — вписать с реальной ГТД владельца |
| Продажи и сервис в money_flow | ✅ перенесены | data/globerent/flows-2026-08-04.json: 674 прихода из счетов-фактур 2022–2026 (сумма с НДС, дата документа=дате оплаты — допущение реестра, «не учитывать»-пометки книги исключены) + 90 сервисных расходов (механик/электрик/материалы, листы «сервис 2025/2026», 36 строк без даты пропущены честно). Категории: sale 291 / service 205 / rent 99 / other 79; 38 продаж привязаны к машинам по серийнику. Блок flows в registry-import, дедуп по docNo+purpose |
