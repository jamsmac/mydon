...
| КП | ✅ по реальным образцам | ОСНОВНОЙ бланк — kp-globerent.ts, снят с 4 настоящих КП владельца (CPD15/CPD20/BF30-1/CBD30-170HA, 2026-08-04): шапка GLOBERENT·HELI, коричневая гамма, «Цена с НДС» оранжевым, «Общие условия» (50/50, дефолты с образцов), гарантия HELI (2 года/4 000 м-ч, Li-Ion 5 лет), футер с реквизитами, страницы полных характеристик. POST /kp/globerent + блок «КП по бланку GLOBERENT» в калькуляторе (цена из сценария). Нумерация КП-ГГГГ/ММДД-N. kp-classic.ts (шаблон донора TAS) остаётся альтернативой |
