...
- **TRent** — аренда строительной техники, отдельный движок и база (`/trent`)
...
- **Базы движков не сливать:** общая оболочка — да, общая БД для всего — нет. VHM24/TRent держат свои схемы.
