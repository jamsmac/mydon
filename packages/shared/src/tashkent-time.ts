 ...
 *
 * Живёт здесь, а не у потребителей: суточные отчёты вендинга завели свою копию
 * смещения (`TZ_OFFSET_MS` в `shrinkage.service.ts`), и вторая константа зоны в
 * коде — ровно та развилка, на которой донор VendCash уехал на пять часов.
