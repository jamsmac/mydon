...
// живёт legacy-проверка entity.attrs, здесь — типизированный блок прайса.
export * from "./fiscal";
...
/**
 * Серия зелёных дней паритета OurVend (П8b): гейт переключения источника
 * учёта. Чистый счёт по журналу событий — числа, по которым гасят донора,
 * обязаны быть проверяемы без базы.
 */
export * from "./parity-streak";
/**
