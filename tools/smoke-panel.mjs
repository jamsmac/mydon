...
const СТРАНИЦЫ = [
  ...
  // «Система» серверно читает единый LLM-ledger. Здесь проверяем SSR и новый
  // UI-блок; прямой endpoint и агрегатный SQL отдельно проверяет smoke-core.
  { path: "/system", должно: "LLM-мониторинг" },
