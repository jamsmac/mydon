 ...
 *
 * ⚠️ СКЛАДЫ ВИДНЫ И ЗДЕСЬ, И В «НОМЕНКЛАТУРЕ». Это не оплошность, а два
 * разных вопроса к одним и тем же карточкам: здесь — «где это физически и что
 * там сейчас стоит», в «Номенклатуре» — «сколько у нас складов и что на них
 * заведено». Точки продаж (их 29) листа в «Номенклатуре» не имеют вовсе и
 * живут только тут — поэтому убрать вид `warehouse` отсюда ради снятия дубля
 * значило бы разорвать один экран мест на два по случайному признаку.
 * Разводится подписями, а не структурой.
 */
  ...
  return (
    <>
      <div className="page-head">
        ...
        <p className="hint">
          Где автомат может стоять. Карточки складов те же, что в «Номенклатуре» — здесь они
