              ...
              <div className="sect" id="bunkers">
                ...
                {coffeeBunkers.length === 0 ? (
                  <div className="empty">
                    ...
                    может быть, а заливок ещё не быть — тогда здесь пусто. Плитки появятся
                  ...
                  <>
                    ...
                    <p className="hint" style={{ marginTop: 8 }}>
                      Полоса — сколько залили в последний раз против эталона позиции, а не сколько
                      осталось сейчас: между взвешиваниями остаток бункера не наблюдается.
