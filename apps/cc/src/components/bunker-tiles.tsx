 ...
 * эталон позиции задан — полоса «сколько залили против эталона». Это НЕ
 * текущий остаток (R-B-9): между взвешиваниями его система не наблюдает, и
 * подпись «заполнен N%» читалась бы как «сейчас в бункере N%». Без эталона показываем вес и
          ...
          <div className={`bnk${залито === null ? " bnk-empty" : ""}${мало ? " bnk-low" : ""}`} key={pos}>
            ...
            {залито === null ? (
              ...
              <>
                ...
                {pct !== null ? (
                  <div className="bnk-bar" title={`Последняя заливка — ${pct}% эталона. Сколько осталось сейчас, не видно: между взвешиваниями остаток не наблюдается`}>
