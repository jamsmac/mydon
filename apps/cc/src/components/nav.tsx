...
const SYSTEM = [
  ...
  // Узлы — карточки миксеров/гриндеров/варок/бункеров с инвентарными номерами:
  // сквозной реестр, а не вкладка направления (спека vendhub-parts).
  { href: "/parts", icon: "box", label: "Узлы" },
