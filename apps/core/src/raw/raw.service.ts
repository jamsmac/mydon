...
export class RawService {
  ...
  /**
   * Дневная сверка союза с OurVend по строкам `sale`.
   *
   * OurVend — единственный дневной источник (нет ни номера заказа, ни времени
   * внутри дня), поэтому и вливается он не построчно, как gjvending с
   * vendinghub, а дневным итогом. Диапазон берём по дням союза: спрашивать у
   * OurVend больше, чем есть в союзе, незачем.
   */
