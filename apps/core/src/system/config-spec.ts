...
export const CONFIG_SPECS: ConfigSpec[] = [
  ...
  },
  {
    ...
    fallback: "180",
    help:
      "Ниже 90 панель не примет; 180 — окно отчёта о мёртвом стоке (DEAD_STOCK_DAYS_MAX). " +
      "Между 90 и 180 отчёт посчитается по обрезанной истории — молча и без предупреждения.",
