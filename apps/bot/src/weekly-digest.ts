 ...
 *
 * Все строки — общие форматтеры «сверки» (`analytics-brief.ts`), а не их
 * пересказ. Своя формулировка разошлась бы с отчётом ровно там, где это дороже
 * всего: пустой журнал прогонов при `failedStreak: 0` читался бы как «✅
