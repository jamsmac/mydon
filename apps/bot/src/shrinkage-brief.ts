 ...
 *
 * Экспортируется ради аналитики снека (analytics-brief.ts): вторая копия
 * разъехалась бы по этой самой замене пробела, и одна и та же сумма в двух
 * отчётах владельца искалась бы по-разному.
 */
